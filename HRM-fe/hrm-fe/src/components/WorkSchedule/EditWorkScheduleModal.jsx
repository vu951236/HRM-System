...
import { getEmployees, getShifts } from '../../services/DataApi.js';

const EditWorkScheduleModal = ({ schedule, onClose, onUpdate }) => {
        ...
        <div className="modal-overlay">
            <div className="modal">
                ...
                <div style={{ marginTop: '20px', textAlign: 'right' }}>
                    ...
                    <button onClick={handleSubmit}>Cập nhật lịch làm</button>
                </div>
            </div>
        </div>
    );
